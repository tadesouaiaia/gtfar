...
def runthrough(fName,genomePath,filters,prefix,readlen,gapcands,mutationList):
    ...
    gtf = GtfFile(fName,prefix,readlen,filters,gapcands,mutationList,printKEY=True)
    while gtf.open:
...
if __name__ == '__main__':
    ...
    parser.add_option("-f", "--filterseqs", default = "HUMAN", type='string', help="Path to filter seqs (ribosomal/mitochondrial)")
